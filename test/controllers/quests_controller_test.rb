...
class QuestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create quest" do
    assert_difference('Quest.count') do
      post quests_url, params: { quest: { description: @quest.description, started_at: @quest.started_at, time_limit: @quest.time_limit, title: @quest.title } }
    end
  ...
  test "should update quest" do
    patch quest_url(@quest), params: { quest: { description: @quest.description, started_at: @quest.started_at, time_limit: @quest.time_limit, title: @quest.title } }
